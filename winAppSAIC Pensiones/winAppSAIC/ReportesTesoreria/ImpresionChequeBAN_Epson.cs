...
{
    public partial class ImpresionChequeBAN_Epson : DevExpress.XtraReports.UI.XtraReport
    {
        public ImpresionChequeBAN_Epson()
        {
            InitializeComponent();
        }

        private void ImpresionChequeBAN_DataSourceDemanded(object sender, EventArgs e)
        {
