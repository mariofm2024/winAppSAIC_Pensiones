...
{
    public partial class ImpresionChequeBX_Epson : DevExpress.XtraReports.UI.XtraReport
    {
        public ImpresionChequeBX_Epson()
        {
            InitializeComponent();
        }

        private void ImpresionChequeBX_DataSourceDemanded(object sender, EventArgs e)
        {
