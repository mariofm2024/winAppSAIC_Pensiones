...
{
    public partial class ImpresionChequeHSBC : DevExpress.XtraReports.UI.XtraReport
    {
        public ImpresionChequeHSBC()
        {
            InitializeComponent();
        }

        private void ImpresionChequeHSBC_DataSourceDemanded(object sender, EventArgs e)
        {
