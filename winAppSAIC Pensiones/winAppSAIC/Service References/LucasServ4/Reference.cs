...
namespace winAppSAIC.LucasServ4 {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="LucasServ4.IFacturacion40Service")]
    public interface IFacturacion40Service {
        ...
        winAppSAIC.LucasServ4.objComprobante40 GenerarComprobante(string cGuid, string strComprobante);
        ...
        winAppSAIC.LucasServ4.objComprobante40 GenerarComprobanteSellado(string cGuid, string strComprobante);
        ...
        winAppSAIC.LucasServ4.objCancelar FacturacionCancelar40(string cGuid, string cRfcEmisor, string cUuid, string cRfcReceptor, decimal dMonto, string cPublicKeyPem, string cPrivateKeyPem, string cMotivo, string cFolioSustitucion);
        ...
        winAppSAIC.LucasServ4.objCancelar FacturacionCancelar40v02(string cGuid, string cRfcEmisor, string cUuid, string cMotivo, string cFolioSustitucion);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IFacturacion40Service/FacturacionCancelar40v03", ReplyAction="http://tempuri.org/IFacturacion40Service/FacturacionCancelar40v03Response")]
        winAppSAIC.LucasServ4.objCancelar FacturacionCancelar40v03(string cGuid, string cRfcEmisor, string cUuid, string cMotivo, string cFolioSustitucion);
        ...
        winAppSAIC.LucasServ4.objEstadoSAT FacturacionConsultarEstadoSAT(string cGuid, string cRfcEmisor, string cUuid, string cRfcReceptor, decimal dMonto);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IFacturacion40ServiceChannel : winAppSAIC.LucasServ4.IFacturacion40Service, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Facturacion40ServiceClient : System.ServiceModel.ClientBase<winAppSAIC.LucasServ4.IFacturacion40Service>, winAppSAIC.LucasServ4.IFacturacion40Service {
        ...
        public winAppSAIC.LucasServ4.objComprobante40 GenerarComprobante(string cGuid, string strComprobante) {
            return base.Channel.GenerarComprobante(cGuid, strComprobante);
        }
        
        public winAppSAIC.LucasServ4.objComprobante40 GenerarComprobanteSellado(string cGuid, string strComprobante) {
            return base.Channel.GenerarComprobanteSellado(cGuid, strComprobante);
        }
        
        public winAppSAIC.LucasServ4.objCancelar FacturacionCancelar40(string cGuid, string cRfcEmisor, string cUuid, string cRfcReceptor, decimal dMonto, string cPublicKeyPem, string cPrivateKeyPem, string cMotivo, string cFolioSustitucion) {
        ...
        public winAppSAIC.LucasServ4.objCancelar FacturacionCancelar40v02(string cGuid, string cRfcEmisor, string cUuid, string cMotivo, string cFolioSustitucion) {
            return base.Channel.FacturacionCancelar40v02(cGuid, cRfcEmisor, cUuid, cMotivo, cFolioSustitucion);
        }
        
        public winAppSAIC.LucasServ4.objCancelar FacturacionCancelar40v03(string cGuid, string cRfcEmisor, string cUuid, string cMotivo, string cFolioSustitucion) {
            return base.Channel.FacturacionCancelar40v03(cGuid, cRfcEmisor, cUuid, cMotivo, cFolioSustitucion);
        }
        
        public winAppSAIC.LucasServ4.objEstadoSAT FacturacionConsultarEstadoSAT(string cGuid, string cRfcEmisor, string cUuid, string cRfcReceptor, decimal dMonto) {
