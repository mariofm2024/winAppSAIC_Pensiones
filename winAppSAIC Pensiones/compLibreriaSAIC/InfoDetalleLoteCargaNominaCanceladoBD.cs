...
{
    public static class InfoDetalleLoteCargaNominaCanceladoBD
    {
        /// <summary>
        ...
        public static InfoDetalleSolicitudCancelacionNomina ObtenerInfoDetalleLoteCargaNominaCancelado(DataTable dt)
        {
